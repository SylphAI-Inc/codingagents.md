...
template: splash
hero:
  tagline: "The open directory for coding agents, models, SDKs, benchmarks, tools, MCPs, skills, protocols, and research."
  actions:
    - text: Explore Agents
...
<CardGrid>
  <Card title="10+ Agents">
    AdaL CLI · Claude Code · Cursor · Copilot · Codex · Gemini CLI · Devin · Windsurf · Amp
  </Card>
  ...
  <Card title="7+ Agent SDKs">
    AdalFlow · LangGraph · OpenAI Agents SDK · CrewAI · Microsoft Agent Framework · Pydantic AI · Smolagents
  </Card>
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard
    title="Agent SDKs"
    description="AdalFlow, LangGraph, OpenAI Agents SDK, CrewAI, and more — the frameworks behind the agents"
    href="/sdks/overview/"
  />
  <LinkCard
    title="Guides"
